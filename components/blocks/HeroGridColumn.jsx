...
export default function HeroGridColumn() {
  const data = [
    ...
    },
    {
      ...
      description: `Lorem ipsum dolor sit amet, consectetur adipiscing, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.`,
      image: "/images/Hero2.webp",
      color: "#7f821c",
    },
    {
      title: "Impacting the World for Good",
      description: `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor nt mollit anim id est laborum.`,
      image: "/images/Hero2.webp",
      color: "#9a0c16",
    },
  ];
