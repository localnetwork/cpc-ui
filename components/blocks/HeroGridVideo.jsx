...
const Fancybox = dynamic(() =>
  import("../partials/Popup/FancyBox").then((module) => module.default)
);
      ...
      <div className="container">
        <div className="flex flex-wrap gap-y-[15px] md:flex-row mx-[-30px] justify-between items-center">
          ...
          {showLazy ? (
            <Fancybox>
              <div
                className="order-[-1] cursor-pointer md:order-[1] px-[15px] md:px-[30px] lg:max-w-[50%] w-full relative group"
