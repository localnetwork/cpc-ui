...
export const components = {
  ...
  LandscapeMediaText: dynamic(() =>
    import("../../components/blocks/LandscapeMediaText").then(
      (module) => module.default
    )
  ),
  KeyPeople: dynamic(() =>
    import("../../components/blocks/KeyPeople").then((module) => module.default)
  ),
  OurPeople: dynamic(() =>
    import("../../components/blocks/OurPeople").then((module) => module.default)
  ),
  CardsWithAccordion: dynamic(() =>
    import("../../components/blocks/CardsWithAccordion").then(
      (module) => module.default
    )
  ),
  BannerMediaText: dynamic(() =>
    import("../../components/blocks/BannerMediaText").then(
      (module) => module.default
    )
  ),
  PortraitMediaText: dynamic(() =>
    import("../../components/blocks/PortraitMediaText").then(
      (module) => module.default
    )
  ),
  MediaCard: dynamic(() =>
    import("../../components/blocks/MediaCard").then((module) => module.default)
  ),
};
